...
def main():
    ...
    # 設定変数
    naming_var = tk.StringVar(value="随時命名")
    ...
    ttk.Radiobutton(naming_frame, text="随時命名", variable=naming_var, value="随時命名").pack(anchor="w")
    ttk.Radiobutton(naming_frame, text="そのまま", variable=naming_var, value="そのまま").pack(anchor="w")
    ...
    ttk.Radiobutton(compress_frame, text="そのまま", variable=compress_var, value="そのまま", command=on_compression_selected).pack(anchor="w")
